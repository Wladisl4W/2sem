...
<head>
    ...
    <link rel="stylesheet" href="../style.css"> <!-- Обновляем путь к style.css -->
    ...
    <div class="container-narrow">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="../index.html" class="btn btn-primary w-100 mt-3">На главную</a> <!-- Обновляем путь к index.html -->
            </div>
        </div>
    </div>
    <?php session_destroy(); ?>
